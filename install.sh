...
reinstall_system() {
    ...
    echo -e "  --password PASSWORD  设置密码"
    echo -e "  --ssh-port PORT      修改 SSH 端口 (安装期间观察日志用，也作用于新系统)"
    echo -e ""
    echo -e "${YELLOW}支持的系统列表 (示例: bash reinstall.sh debian 12):${PLAIN}"
    echo -e "  anolis      7|8|23"
    echo -e "  rocky       8|9|10"
    echo -e "  oracle      8|9|10"
    echo -e "  almalinux   8|9|10"
    echo -e "  opencloudos 8|9|23"
    echo -e "  centos      9|10"
    echo -e "  fnos        1"
    echo -e "  nixos       25.11"
    echo -e "  fedora      42|43"
    echo -e "  debian      9|10|11|12|13"
    echo -e "  alpine      3.20|3.21|3.22|3.23"
    echo -e "  opensuse    15.6|16.0|tumbleweed"
    echo -e "  openeuler   20.03|22.03|24.03|25.09"
    echo -e "  ubuntu      16.04|18.04|20.04|22.04|24.04|25.10 [--minimal]"
    echo -e "  kali"
    echo -e "  arch"
    echo -e "  gentoo"
    echo -e "  aosc"
    echo -e "  redhat      --img=\"http://access.cdn.redhat.com/xxx.qcow2\""
    echo -e ""
